...
"""Central configuration for comparables engine.
Adjust band progressions & scoring weights here so logic stays DRY.
"""
...
# Maximum cached comparable result entries (LRU). Set to 0 / negative to disable.
