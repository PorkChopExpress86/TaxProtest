...
def compute_pricing_stats(subject: Dict[str, Any], comps: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    Returns a dict with keys: value_stats, ppsf_stats, subject_vs_value, subject_vs_ppsf,
    ppsf_band_counts, pool_match_rate, garage_match_rate, trimmed_ppsf_median (when applicable).
